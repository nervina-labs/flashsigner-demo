...
import type { ModalContentProps, AlertStatus, ModalProps, ModalBodyProps } from '@chakra-ui/react'
...
export const useConfirmDialog = () => {
  ...
  const confirm = useCallback(
    async ({ onCancel, onClose, onConfirm, ...options }: ConfirmDialogProps) => {
      setOptions(options)
      setIsOpen(true)
    ...
    [setOptions, setIsOpen, setIsLoading, setOnClose, setOnConfirm, setOnCancel, setCancelLoading],
  )
